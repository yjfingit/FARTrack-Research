"""Summarize node-10 partition AO and aggregate tracker throughput."""
...
def paired_bootstrap(delta, samples=10000, seed=20260820):
    ...
    values = [float(delta[indices].mean()) for indices in rng.integers(0, len(delta), size=(samples, len(delta)))]
