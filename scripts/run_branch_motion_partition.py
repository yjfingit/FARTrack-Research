"""Run one deterministic public GOT-10k validation partition for node 10."""
...
def main():
    ...
    run_dataset(dataset, [Tracker(args.tracker_name, args.tracker_param, "got10k_val", args.run_id)],
